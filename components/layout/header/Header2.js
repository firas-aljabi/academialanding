                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <ul className="tg-header__top-right tg-header__top-right-two list-wrap">
                                        <li><i className="flaticon-envelope" /><Link href="mailto:info@Academia.com">info@Academia.com</Link></li>
                                        ...
                                        <nav className="tgmobile__menu-box">
                                            ...
                                            <div className="tgmobile__menu-bottom">
                                                <div className="contact-info">
                                                    <ul className="list-wrap">
                                                        <li><Link href="mailto:info@Academia.com">info@Academia.com</Link></li>
