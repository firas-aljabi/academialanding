                                ...
                                <div className="row">
                                    <div className="col-lg-7">
                                        <div className="banner__content-three">
                                            ...
                                            <p>Academia helps you to convert your data into a strategic asset and get business insights Academia helps you to convert your data into Asset and get Top-Notch Business Insights.</p>
